		...
		<div class="col-md-2">
                <div class="box border0">
                    ...
                    <ul class="tablists">
                        ...
                        <li class="<?php echo set_Submenu('studentcertificate/index'); ?>">
                            <a class="<?php echo set_Submenu('studentcertificate/index'); ?>" href="<?php echo base_url(); ?>admin/studentcertificate"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/certificates/1.png" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('student_certificate'); ?></a>
                        </li>     
                        ...
                        <?php
                            ...
                            if ($this->rbac->hasPrivilege('generate_certificate', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('admin/generatecertificate'); ?>">
                            <a class="<?php echo set_Submenu('admin/generatecertificate'); ?>" href="<?php echo base_url(); ?>admin/generatecertificate/"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/certificates/2.png" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('generate'); ?> <?php echo $this->lang->line('certificate'); ?></a>
                        </li>
                        ...
                        <?php
                            ...
                            if ($this->rbac->hasPrivilege('student_id_card', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('admin/studentidcard'); ?>">
                            <a class="<?php echo set_Submenu('admin/studentidcard'); ?>" href="<?php echo base_url('admin/studentidcard/'); ?>"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/certificates/3.png" alt="icon3" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('student_id_card'); ?></a>
                        </li> 
                        ...
                        <?php
                            ...
                            if ($this->rbac->hasPrivilege('generate_id_card', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('generateidcard/search'); ?>">
                            <a class="<?php echo set_Submenu('generateidcard/search'); ?>" href="<?php echo base_url('admin/generateidcard/search'); ?>"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/certificates/4.png" alt="icon4" class="img-fluid" style="width:20px"><?php echo $this->lang->line('generate_id_card'); ?></a>
                        </li>
                        <?php
                            }
                            if ($this->rbac->hasPrivilege('staff_id_card', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('admin/staffidcard'); ?>">
                            <a class="<?php echo set_Submenu('admin/staffidcard'); ?>" href="<?php echo base_url('admin/staffidcard/'); ?>"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/certificates/5.png" alt="icon5" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('staff_id_card'); ?></a>
                        </li>
                        <?php
                            }
                            if ($this->rbac->hasPrivilege('generate_staff_id_card', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('admin/generatestaffidcard'); ?>">
                            <a class="<?php echo set_Submenu('admin/generatestaffidcard'); ?>" href="<?php echo base_url('admin/generatestaffidcard/'); ?>"><img src="<?php echo base_url(); ?>/backend/images/sidebar/submenu/certificates/6.png" alt="icon6" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('generate_staff_id_card'); ?></a>
                        </li>
                        <?php
                             } ?>
