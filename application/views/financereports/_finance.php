            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    if ($this->rbac->hasPrivilege('balance_fees_report', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/studentacademicfeereceipt'); ?>"><a href="<?php echo base_url(); ?>financereports/studentacademicfeereceipt"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('studentacademicfeereceipt'); ?></a></li>
                    ...
                    if ($this->rbac->hasPrivilege('day_collection', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/reportdaycollection'); ?>"><a href="<?php echo site_url('financereports/reportdaycollection'); ?>"><i class="fa fa-file-text-o"></i><?php echo $this->lang->line('day_collection_report'); ?> </a></li>

                    <?php } ?>

                    <?php if ($this->rbac->hasPrivilege('balance_fees_report', 'can_view')) {  ?>

                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/studentdayacademicreport'); ?>"><a href="<?php echo base_url(); ?>financereports/studentdayacademicreport"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('studentdayacademicreport'); ?></a></li>
