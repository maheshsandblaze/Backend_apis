                                        ...
                                        <div id="checkbox-dropdown-container">
                                            <div class="">
                                                ...
                                                <div id="custom-select-option-box">
                                                 ...
                                                 <?php if(!empty($feesessiongrouplist)) { ?>
                                                    ...
                                                    <div class="custom-select-option checkbox">
                                                        <?php foreach ($feeTypes as $ftype) { ?>
                                                            <label class="vertical-middle line-h-18">
                                                                <input class="custom-select-option-checkbox fee_type" type="checkbox" name="ftype[]" value="<?php echo $ftype['id']; ?>" data-feetype-id="<?php echo $ftype['id']; ?>"> <?php echo $ftype['type']; ?>
                                                            </label>
                                                        <?php } ?>
                                                    </div>
                                                    ...
                                                    ?>
                                                        <div class="custom-select-option group_name">
                                                            <?php echo $feecategory->group_name ?>
                                                        </div>
                                                        <?php if (!empty($feecategory->feetypes)) {
                                                            foreach ($feecategory->feetypes as $fee_value) {
                                                                ...
                                                                if (!empty($fee_value->type)) { ?>
                                                                    <div class="custom-select-option checkbox">
                                                                        <label class="vertical-middle line-h-18">
                                                                            <input value="<?php echo $feecategory->id . "-" . $fee_value->id; ?>" class="custom-select-option-checkbox fee_type_group" type="checkbox" name="feegroup[]" <?php echo set_checkbox("feegroup[]", $feecategory->id . "-" . $fee_value->id) ?> data-feetype-id="<?php echo $fee_value->feetype_id; ?>">
...
<script>
    ...
    $('.fee_type').change(function() {
        var feetypeId = $(this).data('feetype-id');
        if ($(this).is(':checked')) {
            // Select corresponding fee_type_group checkboxes
            $('.fee_type_group[data-feetype-id="' + feetypeId + '"]').prop('checked', true);
        } else {
            // Deselect corresponding fee_type_group checkboxes
            $('.fee_type_group[data-feetype-id="' + feetypeId + '"]').prop('checked', false);
        }
    });
</script>