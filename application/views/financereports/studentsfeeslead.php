        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('financereports/assignleadsstudent') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        ?>
                        <form method="post" action="<?php echo site_url('financereports/assignagentstudents') ?>" id="assign_form">
                        <input type="hidden" name="form_class_id" value =  "<?php echo set_value('class_id'); ?> ">
                        <input type="hidden" name="form_section_id" value =  "<?php echo set_value('section_id'); ?> ">
                        <input type="hidden" name="form_assign_id" value =  "<?php echo set_value('assign_by'); ?> ">
                        <input type="hidden" name="form_feetype_id" value =  "<?php echo set_value('feetype_id'); ?> ">
                        <div class="" id="duefee">
                            <div class="box-header ptbnull"></div>
            ...
            ?>
                                                ...
                                                <td><?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></td>
                                                            ...
                                                            <td class="mailbox-date text-right white-space-nowrap">
                                                                <?php if (true) {?>
                                                                    <a class="btn btn-default btn-xs" onclick="follow_up(<?php echo $student['id']; ?>, <?php echo $staff_id; ?>, <?php echo $feetype_id; ?>);"  data-target="#follow_up" data-toggle="modal"  title="Follow Up Enquiry">
...
<script>
    ...
    function follow_up(student_id, agent_id, feetype_id) {
        $.ajax({
            url: '<?php echo base_url(); ?>admin/enquiry/fee_enquiry/' + student_id + '/' + agent_id + '/'+feetype_id,
            dataType: 'JSON',
            success: function (data) {
