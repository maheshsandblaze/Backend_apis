            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('exam_schedule_list'); ?></h3>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name"> <?php $sn = 1;
                                                                        ...
                                                                        ?>
                                                    <ul class="liststyle1">
                                                        <li><?php echo $datavalue['maximum_marks']; ?></li>
                                                    </ul>
                                            ...
                                            <td class="mailbox-name"> <?php $sn = 1;
                                                                        ...
                                                                        ?>
                                                    <ul class="liststyle1">
                                                        <li><?php echo $datavalue['pass_percentage']; ?></li>
                                                    </ul>
                                            ...
                                            <td class="mailbox-name"> <?php $sn = 1;
                                                                        ...
                                                                        ?>
                                                    <ul class="liststyle1">
                                                        <li><?php echo $datavalue['description']; ?></li>
                                                    </ul>
