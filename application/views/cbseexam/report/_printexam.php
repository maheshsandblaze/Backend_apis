                    ...
                    <tr>
                        ...
                        ?>
                                <th class="text-center">
                                    ...
                                    <br />
                                    ( <?php echo $this->lang->line('max'); ?> - <?php if($subject_value->subject_name == "Physical Science" || $subject_value->subject_name =="Biology"){ echo  $exam_assessment_value->maximum_marks / 2; } else {  echo $exam_assessment_value->maximum_marks;} ?>)                                </th>
                        <?php
                            }
                        }
                        ?>
                            ...
                            <tr>
                                ...
                                ?>
                                        <td class="text-center">
                                            ...
                                            if ($subject_value->subject_name == "Physical Science" || $subject_value->subject_name == "Biology") {

                                                $total_max_marks = $total_max_marks + $assessment_array['maximum_marks'] / 2;
                                            } else {
