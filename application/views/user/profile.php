...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="row">
            <div class="box-header hide-desktop">
                <div class="btn-group">
                    <button onclick="window.history.back(); " class="btn btn-primary btn-sm"> <i class="fa fa-arrow-left"></i> Back</button>
                </div>
                <div class="btn-group pull-right">
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>site/logout"><i class="fa fa-sign-out fa-fw"></i><?php echo $this->lang->line('logout'); ?></a>
                </div>
            </div>
       ...
       <?php
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if ($this->module_lib->hasActive('fees_collection') && $this->studentmodule_lib->hasActive('fees')) { ?>
                            <li class="hide-mobile-only"><a href="#fee" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('fees'); ?></a></li>
                        <?php } ?>

                        <?php if ($this->module_lib->hasActive('examination') && $this->studentmodule_lib->hasActive('examinations')) { ?>
                            <li class="hide-mobile-only"><a href="#exam" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('exam'); ?></a></li>
                        <?php } ?>
                        ...
                        <?php if ($sch_setting->upload_documents) { ?>
                            <li class="hide-mobile-only"><a href="#documents" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('documents'); ?></a></li>
                        <?php } ?>

                        <!-- behavioural note -->


                        <li class=""><a href="#behavioural_note" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('behavioural_note'); ?></a></li>
                        ...
                        ?>
                                <li class="hide-mobile-only"><a href="#timeline" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('timeline'); ?></a></li>
                        <?php }
                        } ?>
                        ...
                        <?php
                        if ($this->module_lib->hasModule('behaviour_records') && $this->module_lib->hasActive('behaviour_records') && $this->studentmodule_lib->hasActive('behaviour_records')) {  ?>
                            <li class="hide-mobile-only"><a href="#incident" data-toggle="tab" aria-expanded="true"><?php echo $this->lang->line('student_behaviour'); ?></a></li>
                        <?php
                        }
                        ?>
                        <!------- Behaviour Report End--------->
                        ...
                        ?>
                            <li class="pull-right hide-mobile-only">
        ...
        "> <?php } ?></td>
                        ...
                        <!-- behavioral note -->
                        <div class="tab-pane" id="behavioural_note">
                            <div class="timeline-header no-border">

                                <?php

                                if (!empty($behavioural_note)) {

                                    foreach ($behavioural_note  as $note) {
                                ...
                                ?>
                                        ...
                                        <table class="table table-striped mb0">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $note['collected_by']; ?></td>
                                            </tr>
                                            <tr>

                                                <th><?php echo $this->lang->line('date'); ?></th>
                                                <td><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($note['date'])); ?></td>
                                            </tr>


                                            <tr>
                                                <th>Handwriting</th>
                                                <td colspan="3"><?php echo ($note['parameter_1']); ?></td>
                                            </tr>


                                            <tr>
                                                <th>Listening</th>
                                                <td colspan="3"><?php echo ($note['parameter_2']); ?></td>
                                            </tr>
                                            <tr>
                                                <th>Behaviour In Class Room</th>
                                                <td colspan="3"><?php echo ($note['parameter_3']); ?></td>
                                            </tr>
                                            <tr>
                                                <th>Behaviour With Teachers</th>
                                                <td colspan="3"><?php echo ($note['parameter_4']); ?></td>
                                            </tr>
                                            <tr>
                                                <th>Behaviour With Classmates / Elders And Youngers</th>
                                                <td colspan="3"><?php echo ($note['parameter_5']); ?></td>
                                            </tr>
                                            <tr>
                                                <th>Behaviour In Campus</th>
                                                <td colspan="3"><?php echo ($note['parameter_6']); ?></td>
                                            </tr>
                                            <tr>
                                                <th>Bike</th>
                                                <td colspan="3"><?php echo ($note['parameter_7']); ?></td>
                                            </tr>
