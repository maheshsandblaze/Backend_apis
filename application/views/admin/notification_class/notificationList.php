            ...
            <div class="col-md-12" style="margin-top:10px;">
                <div class="box box-solid1 box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-commenting-o"></i> <?php echo $this->lang->line('circular'); ?></h3>
                        
                        
                            <div class="box-tools pull-right">
                                <?php if ($this->rbac->hasPrivilege('notice_board', 'can_add')) {?>
                                <a href="<?php echo base_url() ?>admin/notification_class/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_circular'); ?></a>
                                <?php }?>
                                <button onclick="window.history.back(); " class="btn btn-primary btn-xs mright5"> <i class="fa fa-arrow-left"></i> Back</button>
                            </div>
                        ...
                        <div class="email-info d-flex">
                            ...
                            <div class="d-flex ptt10 hover-show">
                                ...
                                <?php if ($notification["created_id"] == $user_id) {?>
                                    <a href="<?php echo base_url() ?>admin/notification_class/edit/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                ...
                                <?php if ($notification["created_id"] == $user_id) {?>
                                    ...
                                    <a href="<?php echo base_url() ?>admin/notification_class/delete/<?php echo $notification['id'] ?>" class="" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
...
<script type="text/javascript">
    $('.mail-sidebar').on('click', function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/notification_class/notification',
            method: 'post',
