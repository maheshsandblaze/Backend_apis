<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content-header">
        <h1><i class="fa fa-user-plus"></i> <?php //echo $this->lang->line('student_information'); 
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <input class="checkbox" name="select_all" id="select_all" type="checkbox" autocomplete="off">All</th>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="<?php if (getstudentFeesdue($student['student_session_id'])) {
                                                                    echo 'danger font12';
                                                                } ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.checkbox').not('#select_all').on('change', function() {
            const allChecked = $('.checkbox').not('#select_all').length === $('.checkbox:checked').not('#select_all').length;
