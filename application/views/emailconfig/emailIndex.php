                        ...
                        <div class="box-footer">
                           <div class="row">
                                ...
                                if ($this->rbac->hasPrivilege('email_setting', 'can_edit')) {
                                    ...
                                    <button type="submit" class="btn btn-primary btnleftinfo"><?php echo $this->lang->line('save'); ?></button>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                            ...
                            <div class="box-footer">
                                <div class="pull-right paddA10">
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right"><?php echo $this->lang->line('send'); ?></button>
                                </div>
                            </div>
                            </form>  
                        </div>                     
