...
<form action="<?php echo site_url('cbseexam/exam/addexamsubject') ?>" method="POST" class="ssaddSubject ptt10 autoscroll">
    ...
    <div class="">
        <?php
            $assesment_id = $examDetail['cbse_exam_assessment_id'];
            $assesment_data = $this->cbseexam_exam_model->get_exam_assessment_type_subjects($assesment_id);
            
            $type_ids = [];
            foreach ($assesment_data as $value) {
                $type_ids [] = $value['id'];
            }
