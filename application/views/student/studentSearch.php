        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="box border0">
                    ...
                    <?php if ($this->rbac->hasPrivilege('school_vacancies', 'can_view')) {
                    ?>
                        <li class="<?php echo set_Submenu('admin/school_vacancies/index'); ?>">
                            <a class="<?php echo set_Submenu('admin/school_vacancies/index'); ?>" href="<?php echo base_url(); ?>admin/school_vacancies/index"><img src="<?php echo base_url('backend/images/sidebar/submenu/student_information/2.png') ?>" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('school_vacancies')  ?></a>
                        </li>
                    <?php
                    }
                    ?>
                    <?php if ($this->rbac->hasPrivilege('behavioural_note', 'can_view')) {
                    ?>
                        <li class="<?php echo set_Submenu('admin/behavioural_note/index'); ?>">
                            <a class="<?php echo set_Submenu('admin/behavioural_note/index'); ?>" href="<?php echo base_url(); ?>admin/behavioural_note/index"><img src="<?php echo base_url('backend/images/sidebar/submenu/student_information/2.png') ?>" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('behavioural_note')  ?></a>
                        </li>
                    <?php
                    }
                    ?>

                    <?php if ($this->rbac->hasPrivilege('my_day_today', 'can_view')) {
                    ?>
                        <li class="<?php echo set_Submenu('admin/my_day_today'); ?>">
                            <a class="<?php echo set_Submenu('admin/my_day_today'); ?>" href="<?php echo base_url(); ?>admin/my_day_today"><img src="<?php echo base_url('backend/images/sidebar/submenu/reports/3.png') ?>" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('my_day_today')  ?></a>
                        </li>
                    <?php
                    }
                    ?>
                    ...
                    ?>
                          ...
                          <li class="<?php echo set_Submenu('bulkdetain'); ?>">
                            <a class="<?php echo set_Submenu('bulkdetain'); ?>" href="<?php echo site_url('student/bulkdetain'); ?>"><img src="<?php echo base_url('backend/images/sidebar/submenu/student_information/5.png') ?>" alt="icon6" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('bulk_detain'); ?></a>
                        </li>
                        <?php  }?>
                    </ul>
                </div>
                ...
                <div class="box box-primary">
                    ...
                    <div class="nav-tabs-custom border0 navnoshadow">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="<?php if ($role_id != 9) {
                                            echo "active";
                                        } ?>"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><i class="fa fa-list"></i> <?php echo $this->lang->line('list_view'); ?></a></li>
                            <li class="<?php if ($role_id == 9) {
                                            echo "active";
                                        } ?>"><a href="#tab_2" data-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('details_view'); ?></a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane <?php if ($role_id != 9) {
                                                        echo "active";
                                                    } ?> table-responsive no-padding overflow-visible-lg" id="tab_1">
