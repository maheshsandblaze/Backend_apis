            ...
            <div class="col-md-12">
                <div class="box box-solid">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('circular'); ?></h3>
                    </div>
...
<script type="text/javascript">
    $('.mail-sidebar').on('click', function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>user/notification_class/notification',
            method: 'post',
...
<script>
    $(document).on('click', '.notification_msg', function () {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "user/notification_class/updatestatus",
