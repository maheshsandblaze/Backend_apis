                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <!-- <div class="col-md-3">
                                                <div class="form-group">
                                                    <label><?php echo "Is Invisible User"; ?></label>
                                                    <select name="is_invisible_user" class="form-control">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                        <option value="1" <?php echo set_value('is_invisible_user', $staff['is_invisibles_user'] ?? '') == 1 ? 'selected' : ''; ?>>
                                                            Yes
                                                        </option>
                                                        <option value="0" <?php echo set_value('is_invisible_user', $staff['is_invisibles_user'] ?? '') === '0' || set_value('is_invisible_user', $staff['is_invisibles_user'] ?? '') == 0 ? 'selected' : ''; ?>>
                                                            No
                                                        </option>
                                                    </select>
                                                </div>
