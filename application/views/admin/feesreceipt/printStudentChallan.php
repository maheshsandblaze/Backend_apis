    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="row header ">
                    <div class="col-sm-12">
                        ...
                        <img src="<?php echo site_url("uploads/bankdetails/" . $student->header_image) ?>" style="height: 50px;width: 100%;">
                        <?php
                        ?>
                    </div>
                </div>
                ...
                <div class="row table table-striped table-bordered" style="width: 95%;">
                    <div class="col-xs-12 text-left">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                Admin No &#160;&#160;&#160;: <?php echo $student->admission_no; ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                Name &#160;&#160;&#160;: <?php echo $this->customlib->getFullName($student->firstname, $student->middlename, $student->lastname, $sch_setting->middlename, $sch_setting->lastname); ?>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr class="dark-gray">
                                    ...
                                    <td class="text text-right">
                                        <?php
                                        echo $currency_symbol . amountFormat($student->amount);
                                        ?>
                                    </td>
            ...
            <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-md-12 text text-center">
                        <?php echo $this->lang->line('parent_copy'); ?>
                    </div>
                </div>
                <div class="row table table-striped table-bordered" style="width: 95%;">
                    <div class="col-xs-12 text-left">
