...
<body class="hold-transition skin-blue fixed sidebar-mini">
    ...
    <div class="wrapper">
        <header class="main-header hide-mobile" id="alert">
            <?php
            if ($role == 'guest') {
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="col-lg-5 col-md-3 col-sm-2 col-xs-4">
                    ...
                    <!--<a href="<?php echo base_url(); ?><?php echo $function; ?>" class="logo logo-hide-on-desktop">-->
        ...
        <header class="main-header hide-desktop" id="alert">
            <?php
            if ($role == 'guest') {
                $function = 'user/studentcourse/profile';
            } elseif ($role == 'student') {
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-14 d-flex justify-content-center">
        ...
        <aside class="main-sidebar" id="alert2">
            ...
            ?>
                <section class="sidebar <?php echo ($is_lock_panel) ? "disable-sidebar" : "" ?>">
                    ...
                    <ul class="user-sidebar sidebar-menu verttop38" id="sibe-box">
						...
						<li class="treeview <?php echo set_Topmenu('gallery'); ?>">
                            <a href="<?php echo base_url(); ?>user/content/gallery">
                                <img src="<?php echo site_url('backend/images/sidebar/ce.png') ?>" alt="icon2" class="img-fluid">
                                <span> Gallery</span>
                            </a>
                        </li>

                        <li class="<?php echo set_Topmenu('my_profile'); ?>"><a href="<?php echo base_url(); ?>user/user/profile">
                        ...
                        <?php if ($this->module_lib->hasActive('fees_collection') && $this->studentmodule_lib->hasActive('fees')) { ?>
                            <li class="<?php echo set_Topmenu('fees'); ?>"><a href="<?php echo base_url(); ?>user/user/getfees">
                        ...
                        ?>
                            ...
                            <li class="treeview <?php echo set_Topmenu('notification_class'); ?>">
                                <a href="<?php echo base_url(); ?>user/notification_class">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/noticeboard.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('circular'); ?></span>
                                </a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($this->module_lib->hasModule('online_course') && $this->module_lib->hasActive('online_course') && $this->studentmodule_lib->hasActive('online_course') && $this->auth->addonchk('ssoclc', false)) { ?>
                            <li class="<?php echo set_topmenu('user/studentcourse'); ?>"><a href="<?php echo base_url(); ?>user/studentcourse">
                                    <img src="<?php echo site_url('backend/images/sidebar/1.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('online_course'); ?></span></a></li>
                        <?php } ?>
						
						<li class="<?php echo set_Topmenu('user/studentdairy'); ?>"><a href="<?php echo base_url(); ?>user/studentdairy">
                                <img src="<?php echo site_url('backend/images/sidebar/5.png') ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('student_assessment'); ?></span></a></li>
                        ...
                        <?php if ($this->module_lib->hasModule('zoom_live_classes') && $this->module_lib->hasActive('zoom_live_classes') && $this->studentmodule_lib->hasActive('live_classes') && $this->auth->addonchk('sszlc', false)) { ?>
                            <li class="<?php echo set_topmenu('Conference'); ?>"><a href="<?php echo base_url('user/conference'); ?>">
                                    <img src="<?php echo site_url('backend/images/sidebar/1.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasModule('gmeet_live_classes') && $this->module_lib->hasActive('gmeet_live_classes') && $this->studentmodule_lib->hasActive('gmeet_live_classes') && $this->auth->addonchk('ssglc', false)) { ?>
                            <li class="<?php echo set_topmenu('Gmeet'); ?>"><a href="<?php echo base_url('user/gmeet'); ?>">
                                    <img src="<?php echo site_url('backend/images/sidebar/1.png') ?>" alt="icon2" class="img-fluid">
                                    <?php echo $this->lang->line('gmeet') . " " . $this->lang->line('live_class'); ?></a></li>
                        <?php } ?>

                        <?php if ($this->studentmodule_lib->hasActive('class_timetable')) { ?>
                            <li class="<?php echo set_Topmenu('Time_table'); ?>"><a href="<?php echo base_url(); ?>user/timetable">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/timetable.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasActive('lesson_plan') && $this->studentmodule_lib->hasActive('lesson_plan')) { ?>
                            <li class="<?php echo set_Topmenu('syllabus'); ?>"><a href="<?php echo base_url(); ?>user/syllabus">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/lessonplan.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('lesson_plan'); ?></span></a></li>
                        <?php } ?>

                        <?php if ($this->studentmodule_lib->hasActive('syllabus_status')) { ?>
                            <li class="<?php echo set_Topmenu('syllabus/status'); ?>"><a href="<?php echo base_url(); ?>user/syllabus/status">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/syllabus.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasActive('homework') && $this->studentmodule_lib->hasActive('homework')) { ?>
                            <li class="<?php echo set_Topmenu('Homework'); ?>"><a href="<?php echo base_url(); ?>user/homework">
                                    <img src="<?php echo site_url('backend/images/sidebar/5.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasActive('online_examination') && $this->studentmodule_lib->hasActive('online_examination')) { ?>
                            <li class="treeview <?php echo set_Topmenu('Onlineexam'); ?>"><a href="<?php echo site_url('user/onlineexam'); ?>">
                                    <img src="<?php echo site_url('backend/images/sidebar/1.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('online_exam'); ?></span></a></li>
                        <?php } ?>

                        <?php if ($this->module_lib->hasActive('online_course') && $this->studentmodule_lib->hasActive('online_course')) { ?>
                            <li class="treeview <?php echo set_Topmenu('Onlinecourse'); ?>"><a href="<?php echo site_url('user/onlinecourse'); ?>">
                                    <img src="<?php echo site_url('backend/images/sidebar/8.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('online_course'); ?></span></a></li>
                        <?php } ?>

                        <?php if ($this->studentmodule_lib->hasActive('apply_leave')) { ?>
                            <li class="<?php echo set_Topmenu('apply_leave'); ?>"><a href="<?php echo base_url(); ?>user/apply_leave">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/applyleave.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('apply_leave'); ?></span></a></li>
                        <?php } ?>

                        <?php if ($this->studentmodule_lib->hasActive('visitor_book')) { ?>
                            <li class="<?php echo set_Topmenu('visitors'); ?>"><a href="<?php echo base_url(); ?>user/visitors">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/visitorbook.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasActive('download_center') && $this->studentmodule_lib->hasActive('download_center')) { ?>
                            <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                                <a href="<?php echo base_url(); ?>user/content/list">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/downloadcenter.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasActive('student_attendance') && $this->studentmodule_lib->hasActive('attendance')) { ?>
                            <li class="treeview <?php echo set_Topmenu('Attendence'); ?>"><a href="<?php echo base_url(); ?>user/attendence">
                                    <img src="<?php echo site_url('backend/images/sidebar/4.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        if ($this->module_lib->hasModule('cbseexam') && $this->module_lib->hasActive('cbseexam') && $this->studentmodule_lib->hasActive('cbseexam')) { ?>
                            ...
                            <li class="treeview <?php echo set_Topmenu('cbse_exam'); ?>">
                                <a href="<?php echo site_url('user/cbse/exam/result'); ?>">
                                    <img src="<?php echo site_url('backend/images/sidebar/1.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('cbse_exam'); ?></span>
                                </a>
                                <!-- <ul class="treeview-menu">
                        ...
                        <?php if ($this->studentmodule_lib->hasActive('teachers_rating')) { ?>
                            <li class="<?php echo set_Topmenu('Teachers'); ?>"><a href="<?php echo base_url(); ?>user/teacher">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/treviews.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        <?php if ($this->module_lib->hasActive('library') && $this->studentmodule_lib->hasActive('library')) { ?>
                            <li class="treeview <?php echo set_Topmenu('Library'); ?>">
                                <a href="<?php echo base_url(); ?>user/book">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/library.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('library'); ?></span>
                                </a>
                                <!-- <ul class="treeview-menu">
                        ...
                        <?php if ($this->module_lib->hasActive('transport') && $this->studentmodule_lib->hasActive('transport_routes')) { ?>
                            <li class="<?php echo set_Submenu('route/index'); ?>"><a href="<?php echo base_url(); ?>user/route">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/transport.png') ?>" alt="icon2" class="img-fluid">
                        ...
                        ?>
                            ...
                            <li class="treeview <?php echo set_Topmenu('notification_class'); ?>">
                                <a href="<?php echo base_url(); ?>user/my_day_today">
                                    <img src="<?php echo site_url('backend/images/sidebar/student/syllabus.png') ?>" alt="icon2" class="img-fluid">
                                    <span><?php echo $this->lang->line('my_day_today'); ?></span>
                                </a>
                            </li>
                        <?php } ?>

                        <?php if ($this->module_lib->hasActive('hostel') && $this->studentmodule_lib->hasActive('hostel_rooms')) { ?>
                            <li class="<?php echo set_Submenu('hostelroom/index'); ?>"><a href="<?php echo base_url(); ?>user/hostelroom">
                                    <img src="<?php echo site_url('backend/images/sidebar/ho.png') ?>" alt="icon2" class="img-fluid">
    ...
    <?php /*
                        echo '<li>';
                        echo '<a href="'.site_url('user/user/dashboard')'" data-toggle="tooltip" data-original-title="'.$this->lang->line($side_list_value->lang_key).'">';
                        echo '<img src="'.site_url('backend/images/sidebar/c_t_ta.png')'" alt="icon2">';
					  //echo '<span>'.$this->lang->line($side_list_value->lang_key).'</span>';
						echo '<span style="font-size: 11px; color: black; display: inline-block; white-space: normal; line-height: 1.2; word-wrap: break-word; max-width: 100px;">'.$this->lang->line(dashboard).'</span>';
                        echo '</a>';
                        echo '</li>';
       */
    ?>
        ...
        <nav class="mobile-bottom-nav hide-mobile" id="bottom-menu">
            <ul class="bottom-menu-list">

                <li class="treeview <?php echo set_Topmenu('dashboard'); ?>">
                    <a href="<?php echo base_url(); ?>user/user/dashboard" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('dashboard'); ?>">
                ...
                <li class="<?php echo set_Topmenu('my_profile'); ?>">
                    <a href="<?php echo base_url(); ?>user/user/profile" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('my_profile'); ?>">
                ...
                <?php if ($this->module_lib->hasModule('online_course') && $this->module_lib->hasActive('online_course') && $this->studentmodule_lib->hasActive('online_course') && $this->auth->addonchk('ssoclc', false)) { ?>
                    <li class="<?php echo set_topmenu('user/studentcourse'); ?>"><a href="<?php echo base_url(); ?>user/studentcourse">
                            ...
                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/8.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('online_course'); ?></span>
                            </span>
                        </a></li>
                <?php } ?>

                <?php if ($this->module_lib->hasModule('zoom_live_classes') && $this->module_lib->hasActive('zoom_live_classes') && $this->studentmodule_lib->hasActive('live_classes') && $this->auth->addonchk('sszlc', false)) { ?>
                    <li class="<?php echo set_topmenu('Conference'); ?>">
                        <a href="<?php echo base_url('user/conference'); ?>">

                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/exam.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('zoom_live_classes'); ?></span>
                            </span>
                        </a>
                    </li>
                <?php } ?>
                ...
                <?php if ($this->module_lib->hasModule('gmeet_live_classes') && $this->module_lib->hasActive('gmeet_live_classes') && $this->studentmodule_lib->hasActive('gmeet_live_classes') && $this->auth->addonchk('ssglc', false)) { ?>
                    <li class="<?php echo set_topmenu('Gmeet'); ?>">
                        <a href="<?php echo base_url('user/gmeet'); ?>">
                ...
                <?php if ($this->studentmodule_lib->hasActive('class_timetable')) { ?>
                    <li class="<?php echo set_Topmenu('Time_table'); ?>">
                        <a href="<?php echo base_url(); ?>user/timetable" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('class_timetable'); ?>">
                ...
                <?php if ($this->module_lib->hasActive('lesson_plan') && $this->studentmodule_lib->hasActive('lesson_plan')) { ?>
                    <li class="<?php echo set_Topmenu('syllabus'); ?>">
                        <a href="<?php echo base_url(); ?>user/syllabus" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('lesson_plan'); ?>">
                ...
                <?php if ($this->studentmodule_lib->hasActive('syllabus_status')) { ?>
                    <li class="<?php echo set_Topmenu('syllabus/status'); ?>">
                        <a href="<?php echo base_url(); ?>user/syllabus/status" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('syllabus_status'); ?>">

                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/student/syllabus.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('syllabus_status'); ?></span>
                            </span>
                ...
                <?php if ($this->module_lib->hasActive('online_examination') && $this->studentmodule_lib->hasActive('online_examination')) { ?>
                    <li class="treeview <?php echo set_Topmenu('Onlineexam'); ?>"><a href="<?php echo site_url('user/onlineexam'); ?>" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('online_exam'); ?>">

                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/exam.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('online_exam'); ?></span>
                            </span>
                        </a></li>
                <?php } ?>
                ...
                <?php if ($this->studentmodule_lib->hasActive('apply_leave')) { ?>
                    <li class="<?php echo set_Topmenu('apply_leave'); ?>"><a href="<?php echo base_url(); ?>user/apply_leave">
                            ...
                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/student/applyleave.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('apply_leave'); ?></span>
                            </span>
                        </a></li>
                <?php } ?>
                ...
                <?php if ($this->studentmodule_lib->hasActive('visitor_book')) { ?>
                    <li class="<?php echo set_Topmenu('visitors'); ?>"><a href="<?php echo base_url(); ?>user/visitors">
                            ...
                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/student/visitorbook.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('visitor_book'); ?></span>
                            </span>
                        </a></li>
                <?php } ?>
                ...
                <?php if ($this->module_lib->hasActive('download_center') && $this->studentmodule_lib->hasActive('download_center')) { ?>
                    <li class="treeview <?php echo set_Topmenu('Downloads'); ?>">
                        <a href="<?php echo base_url(); ?>user/content/list" data-toggle="tooltip" data-original-title="<?php echo $this->lang->line('download_center'); ?>">
                        ...
                        <!--<ul class="treeview-menu">
                                    <li class="<?php echo set_Submenu('content/index'); ?>">
                                        <a href="<?php echo base_url(); ?>user/content/list">
										<i class="fa fa-angle-double-right"></i><?php echo $this->lang->line('contents'); ?>
										<span class="info-box-iconn bg-none">
								<img src="<?php echo site_url('backend/images/sidebar/exam.png'); ?>" alt="icon2" class="img-fluid">
								</span>
										</a>
                                    ...
                                    <li class="<?php echo set_Submenu('video_tutorial/index'); ?>"><a href="<?php echo base_url(); ?>user/video_tutorial">
									<i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('video_tutorial'); ?>
									<span class="info-box-iconn bg-none">
								<img src="<?php echo site_url('backend/images/sidebar/exam.png'); ?>" alt="icon2" class="img-fluid">
								</span>
									</a></li>
                ...
                <?php if ($this->module_lib->hasActive('student_attendance') && $this->studentmodule_lib->hasActive('attendance')) { ?>
                    <li class="treeview <?php echo set_Topmenu('Attendence'); ?>">
                ...
                <?php if ($this->studentmodule_lib->hasActive('teachers_rating')) { ?>
                    <li class="<?php echo set_Topmenu('Teachers'); ?>"><a href="<?php echo base_url(); ?>user/teacher">
                            ...
                            <span class="info-box-iconn bg-none">
                                <img src="<?php echo site_url('backend/images/sidebar/student/treviews.png'); ?>" alt="icon2" class="img-fluid">
                                <span><?php echo $this->lang->line('teachers_reviews'); ?></span>
                            </span>
                        </a></li>
                <?php } ?>
