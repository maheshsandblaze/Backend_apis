...
<footer class="main-footer hide-mobile">
...
if ($uri == "admin/admin/dashboard") { ?>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center hide-desktop footer-menu">
                        ...
                        <div class="navbar-custom-menu">
                            ...
                            <ul class="nav navbar-nav headertopmenu">
                                ...
                                <li class="dropdown user-menu">
                                    <a style="padding: 15px 12px;" href="<?php echo base_url() . "admin/staff/profile/" . $id ?>" data-original-title="<?php echo $this->lang->line('my_profile'); ?>" class="profile-text">
                                        <img src="<?php echo base_url($file); ?>" class="topuser-image" alt="User Image">  <?php echo $this->lang->line('my_profile'); ?>
                                    </a>
