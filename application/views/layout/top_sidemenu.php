<ul class="sessionul fixedmenu">
    ...
    ?>
        <li class="removehover">
            <a data-toggle="modal" data-target="#sessionModal"><span><?php echo "Session" . ": </br>" . $this->setting_model->getCurrentSessionName(); ?></span><i class="fa fa-pencil pull-right"></i></a>
