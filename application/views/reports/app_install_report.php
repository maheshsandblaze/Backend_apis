                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('app_install_users_report'); ?></h3>
                        </div>
                        <div class="box-body table-responsive">
                            <div class="download_label"> <?php echo $this->lang->line('app_install_users_report'); ?></div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($resultlist as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat(date("Y-m-d", strtotime($value['created_date'])))); ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
