                    ...
                    <table class="table table-striped">
                        <tbody>
                            <tr>
                                ...
                                <th><label class="checkbox-inline bolds"><input type="checkbox" class="select_all_visible"/> <?php echo $this->lang->line('visible_report_card'); ?></label></th>
                            ...
                            if (empty($resultlist)) {
                                ...
                                foreach ($resultlist as $student) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="checkbox" type="checkbox" name="visible_student[<?php echo $student['student_session_id']; ?>]"  value="1" <?php if($student['reportcard_visible_student']!=0){ echo "checked"; }?> />
                                        </td>
