                    ...
                    <form action="<?php echo site_url("student/edit/" . $id) ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="class_of_admission" name="class_of_admission" placeholder="" type="text" class="form-control" value="<?php echo set_value('class_of_admission', $student['class_of_admission']); ?>" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="child_id" name="child_id" placeholder="" type="text" class="form-control" value="<?php echo set_value('child_id', $student['child_id']); ?>" />
                            ...
                            ?>
                                ...
                                <?php } ?>
                                <div class="tshadow mb25 bozero mainstudent" style="display: none;">
                                    <div id="fade"></div>
                                    <div id="modal">
