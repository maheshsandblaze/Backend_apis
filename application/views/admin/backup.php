                        ...
                        <div class="box-tools pull-right">
                            <form id="form1" action="<?php echo site_url('admin/admin/backup') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" role="form">
                                ...
                                <?php if ($this->rbac->hasPrivilege('backup', 'can_add')) { ?>
                                    <button class="btn btn-primary btn-sm btn-primary" type="submit" name="backup" value="backup"><i class="fa fa-plus-square-o"></i>   <?php echo $this->lang->line('create_backup'); ?></button>
<?php } ?>
                            </form>
                        </div>
                    </div>
    ...
    <?php echo $this->customlib->getCSRF(); ?>
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">   
                                <a class="btn btn-primary btn-sm btn-primary" data-toggle="tooltip" href="<?php echo base_url() . "admin/admin/addCronsecretkey/" . $settinglist[0]['id'] ?>"><?php
