...
<div class="content-wrapper">
    ...
    ?>
                            <button class="btn btn-primary btn-sm pull-right question-btn" data-recordid="0"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_category'); ?></button>
                        <?php
}
?>
                    </div>
										...
										?>
											<tr>
												...
												<td class="pull-right noExport">
													<a href="<?php echo site_url('admin/onlinecourse/list/' . $category['id']); ?>"><i class="fa fa-list"></i></a>
												</td>
