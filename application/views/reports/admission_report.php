...
<?php } ?>
                ...
                <div class="hide-desktop">
                    <form  action="<?php echo site_url('report/admission_report_mobile') ?>" method="post" class="">
                        <div class="box-body row">                           
                            <div class="col-sm-6 col-md-3" >
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('search_type'); ?></label><small class="req"> *</small>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="bgtgray">
                                        ...
                                        <div class="col-sm-4 col-lg-4 col-md-4 border-right">
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('admission_date'); ?> :<span class="description-text"><?php
                                        ...
                                        <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('gender'); ?> : <span class="description-text"><?php echo $student['gender']; ?></span></h5>
                                            </div>
                                        </div>
                                        <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                            <div class="description-block">
