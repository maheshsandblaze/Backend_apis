<?php
class Onlinecourse_model extends MY_model
{
	...
	{
		//print_r($data);exit;
		$this->db->insert('onlinecourse_category', $data);
	...
	{
		//print_r($data);exit;
		$this->db->insert('onlinecourse_videos', $data);
		return $this->db->insert_id(); 
	}
	...
	{
		$this->db->where('id', $id);
		$this->db->update('onlinecourse_videos', $data);
	}

	public function get_categories()
	{
		$query = $this->db->get('onlinecourse_category'); 
	...
	public function getVideosBycatID($id)
	{
		...
		$query = $this->db->get('onlinecourse_videos'); 
		return $query->result_array(); 
	}
    ...
    //this method is for import onlineexam result for bulk uploading
    public function getOnlineExamId($exam_id , $student_session_ids) {
        $this->db->select('onlineexam_students.id, onlineexam_students.student_session_id')->from('onlineexam_students');
        $this->db->where_in('onlineexam_students.student_session_id', $student_session_ids);
