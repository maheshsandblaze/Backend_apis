...
class enquiry_model extends MY_Model
{
    ...
    {
        $query = "SELECT count(*) as `total_leads` FROM `enquiry` where status = 'active' ";
        $query = $this->db->query($query);
        return $query->row();
    }
    
    public function getTotalPassiveLeads()
    {
        $query = "SELECT count(*) as `total_passive` FROM `enquiry` where status = 'passive' ";
        $query = $this->db->query($query);
        return $query->row();
    }
    
    public function getTotalWonLeads()
    {
        $query = "SELECT count(*) as `total_won` FROM `enquiry` where status = 'won' ";
        $query = $this->db->query($query);
        return $query->row();
    }
    
    public function getTotalDeadLeads()
    {
        $query = "SELECT count(*) as `total_dead` FROM `enquiry` where status = 'dead' ";
        $query = $this->db->query($query);
        return $query->row();
    }
