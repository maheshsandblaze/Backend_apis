                    ...
                    <ul class="tablists">
                        <?php if ($this->rbac->hasPrivilege('hostel_rooms', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('hostelroom/index'); ?>">
                                <a class="<?php echo set_Submenu('hostelroom/index'); ?>" href="<?php echo base_url(); ?>admin/hostelroom"><img src="<?php echo base_url('backend/images/sidebar/submenu/reports/12.png') ?>" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('hostel_rooms'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('roomtype/index'); ?>">
                                <a class="<?php echo set_Submenu('roomtype/index'); ?>" href="<?php echo base_url(); ?>admin/roomtype"><img src="<?php echo base_url('backend/images/sidebar/submenu/front_office/2.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('room_type'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('hostel/index'); ?>">
                                <a class="<?php echo set_Submenu('hostel/index'); ?>" href="<?php echo base_url(); ?>admin/hostel"><img src="<?php echo base_url('backend/images/sidebar/submenu/front_office/3.png') ?>" alt="icon3" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('hostel'); ?></a>
                            </li>
                        <?php } ?>
