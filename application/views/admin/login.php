...
<head>
  ...
  #hide { display: block; }  /* show it on small screens */
}

@media screen and (min-width: 301px) and (max-width: 1024px) {
  #hide { display: none; }   /* hide it elsewhere */
}
</style>
        ...
        <div class="inner-bg">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 nopadding-2" id="hide">
                            <div id="login-image " class="d-flex align-items-center text-wrap flex-column justify-content-center bg-position-sm-left bg-position-lg-center" style="background: url('<?php echo base_url(); ?>uploads/school_content/login_image/<?php echo $school['admin_login_page_background']; ?>') no-repeat; background-size:cover">
...
<script type="text/javascript">
    ...
    if (window.innerWidth < 768) { // Adjust the width as per requirement
