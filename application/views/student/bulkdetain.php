                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body pb0">
                        <div class="row">  
                            ...
                            <form role="form" action="<?php echo site_url('student/bulkdetain') ?>" method="post" class="">
                    ...
                    <div class="box-body pt0">
                        <div class="row ">
                            <div class="col-md-12 col-sm-12">
                                <form class="mt10" action="<?php echo site_url('student/ajax_detain') ?>" method="POST" id="deletebulk">
                                    <?php
                                    if (isset($resultlist)) {
                                        ?>                   
                                        <div class="checkbox bordertop pt15">
                                            ...
                                            if (!empty($resultlist)) {
                                                ?>                              
                                                <button type="submit" class="btn btn-primary pull-right btn-sm " id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i>  <?php echo $this->lang->line('please_wait'); ?>"> <?php echo $this->lang->line('detain') ?></button>
                                                <?php
                                            }
                                            ?>
                                        </div> 
                                        <div class="table-responsive pt15 clearboth">
                                            <div class="download_label"><?php echo "Bulk Detain"; ?></div>
                                                        ...
                                                        foreach ($resultlist as $student) {
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="checkbox" name="student[]" value="<?php echo $student['student_session_id']; ?>">
                                                                </td>
...
<script type="text/javascript">
    $("#deletebulk").submit(function (e) {
        ...
        if (checkCount == 0)
        {
            ...
            if (confirm("<?php echo $this->lang->line('are_you_sure_you_want_to_detain'); ?>")) {
