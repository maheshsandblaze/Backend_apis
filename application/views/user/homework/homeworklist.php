                ...
                <div class="box box-info">
                    <div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <div class="btn-group pull-right hide-desktop mleft5">
                    ...
                    <div class="box-body table-responsive">
                        <div class="hide-mobile"> <div class="download_label"><?php echo $this->lang->line('homework_list'); ?></div>
    ...
    ?>
                                ...
                                <div class="box box-primary borderwhite">
                                    <div class="box-header ptbnull bgtgray">
                                        <h3 class="box-title titlefix"><?php echo $homework['subject_name']; ?></h3>
                                        <div class="box-tools pull-right">
                                            <button class="btn btn-primary btn-sm" onclick="evaluation(<?php echo $homework['id']; ?>,<?php echo $h_status; ?>);" title="" data-target="#evaluation" data-toggle="modal"  data-original-title="Evaluation">
                                                    Submit</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('homework_date'); ?> : <span class="description-text"><?php echo $this->customlib->dateformat($homework['homework_date']); ?></span></h5>
                                            </div>
                                        
                                        
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('submission_date'); ?> : <span class="description-text"><?php echo $this->customlib->dateformat($homework['submit_date']); ?></span></h5>
                                            </div>
                                        
                                        
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('evaluation_date'); ?> : <span class="description-text"><?php
$evl_date = "";
    if (!IsNullOrEmptyString($homework['evaluation_date'])) {
        echo $this->customlib->dateformat($homework['evaluation_date']);
    }
    ?></span></h5>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('note'); ?> :<span class="description-text"><?php echo $homework["note"]; ?></span></h5>
                                            </div>
                                        
                                        
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('status'); ?> : <span class="description-text"><?php
    ...
    ?>
                                                <label <?php echo $status_class; ?>><?php echo $status_homework; ?></label></span></h5>
                                            </div>
...
foreach ($closedhomeworklist as $key => $closedhomework) {
    ...
    ?>
                                ...
                                <div class="box box-primary borderwhite">
                                    <div class="box-header ptbnull bgtgray">
                                        <h3 class="box-title titlefix"><?php echo $closedhomework['subject_name']; ?></h3>
                                        <div class="box-tools pull-right">
                                            <button class="btn btn-primary btn-sm" onclick="evaluation(<?php echo $closedhomework['id']; ?>,<?php echo $h_status; ?>);" title="" data-target="#evaluation" data-toggle="modal"  data-original-title="Evaluation">
                                                    Submit</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('homework_date'); ?> : <span class="description-text"><?php echo $this->customlib->dateformat($closedhomework['homework_date']); ?></span></h5>
                                            </div>
                                        
                                        
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('submission_date'); ?> : <span class="description-text"><?php echo $this->customlib->dateformat($closedhomework['submit_date']); ?></span></h5>
                                            </div>
...
$evl_date = "";
    ...
    ?></span></h5>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('note'); ?> :<span class="description-text"><?php echo $closedhomework["note"]; ?></span></h5>
                                            </div>
