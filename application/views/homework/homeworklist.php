                ...
                <div class="box border0">
                    ...
                    <ul class="tablists">
                        <?php if ($this->rbac->hasPrivilege('homework', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('homework'); ?>">
                                <a class="<?php echo set_Submenu('homework'); ?>" href="<?php echo base_url(); ?>homework"><img src="<?php echo base_url('backend/images/sidebar/submenu/homework/1.png') ?>" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('add_homework'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('homework/dailyassignment'); ?>">
                                <a class="<?php echo set_Submenu('homework/dailyassignment'); ?>" href="<?php echo base_url(); ?>homework/dailyassignment"><img src="<?php echo base_url('backend/images/sidebar/submenu/homework/2.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('daily_assignment'); ?></a>
                            </li>
                        <?php } ?>
                        
                        <?php if ($this->rbac->hasPrivilege('studentdairy', 'can_view')) {
                        ?>
                            <li class="<?php echo set_Submenu('studentdairy/index'); ?>">
                                <a class="<?php echo set_Submenu('homework/index'); ?>" href="<?php echo base_url(); ?>studentdairy"><img src="<?php echo base_url('backend/images/sidebar/submenu/homework/1.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('student_dairy'); ?></a>
                            </li>
                        <?php } ?>
