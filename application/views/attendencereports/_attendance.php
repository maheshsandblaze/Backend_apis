        ...
        <div class="box box-primary border0 mb0 margesection">
            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php if ($this->rbac->hasPrivilege('late_entries_report', 'can_view')) {  ?>



                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/attendence/late_entries_report'); ?>"><a href="<?php echo site_url('attendencereports/late_entries_report'); ?>"><i class="fa fa-file-text-o"></i><?php echo $this->lang->line('late_entries_report'); ?> </a></li>
