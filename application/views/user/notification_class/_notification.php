...
<?php if ($notificationlist['attachment'] != '') {?>
     <a href="<?php echo base_url(); ?>user/notification_class/download/<?php echo $notificationlist['id']; ?>"><i class="fa fa-download pr-1"></i><?php echo $this->lang->line('download_attachment'); ?></a>
<?php }?>
