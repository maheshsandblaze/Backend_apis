                                ...
                                <div class="bgtgray">
                                    <div class="col-sm-3 col-lg-2 col-md-3">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('class_section'); ?> : <span class="description-text"><?php echo $value['class_section']; ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 pull ">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('total_present'); ?> : <span class="description-text"><?php echo $value['total_present']; ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 pull ">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('total_absent'); ?> : <span class="description-text"><?php echo $value['total_absent']; ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-lg-4 col-md-4 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('present') . " %"; ?> :<span class="description-text"><?php echo $value['present_percent']; ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('absent') . " %"; ?> : <span class="description-text"><?php echo $value['absent_persent']; ?></span></h5>
                                        </div>
                                    </div>
