...
<head>
    ...
    <style type="text/css">
        * {
        ...
        .studenttop {
            background: <?php echo $idcardlist[0]->header_color; ?>;
            padding: 2px;
            color: #fff;
            overflow: hidden;
            position: relative;
            ...
            <tr>
                <td valign="top" width="32%">
                    <table cellpadding="0" cellspacing="0" width="100%" class="tc-container" style="background: #efefef;">
                        <tr>
                            <td valign="top">
                                <img src="<?php echo base_url('uploads/student_id_card/background/') ?><?php echo $idcardlist[0]->background; ?>" class="tcmybg" />
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
