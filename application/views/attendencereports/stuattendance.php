...
?>
                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive hide-mobile">
                                ...
                                <div class="bgtgray">
                                    <div class="col-sm-3 col-lg-2 col-md-3">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('admission_no'); ?> : <span class="description-text"><?php echo $student['admission_no']; ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 pull ">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('student_name'); ?> : <span class="description-text"><?php echo $this->customlib->getFullName($student['firstname'], $student['middlename'], $student['lastname'], $sch_setting->middlename, $sch_setting->lastname); ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-1 pull ">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('class'); ?> : <span class="description-text"><?php echo $student['class'] . " (" . $student['section'] . ")" ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-lg-4 col-md-4 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('gender'); ?> :<span class="description-text"><?php echo $this->lang->line(strtolower($student['gender'])); ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-2 col-lg-2 col-md-2 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('mobile_number'); ?> : <span class="description-text"><?php echo $student['mobileno']; ?></span></h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-lg-3 col-md-3 border-right">
                                        <div class="description-block">
                                            <h5 class="description-header"><?php echo $this->lang->line('count'); ?> : <span class="description-text"><?php echo $student['total_type']; ?></span></h5>
                                        </div>
                                    </div>
