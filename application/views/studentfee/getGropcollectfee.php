            ...
            <div class="col-lg-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="payment_mode_fee" value="Cash" disabled><?php echo $this->lang->line('cash'); ?>
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="payment_mode_fee" value="card" disabled><?php echo $this->lang->line('card'); ?>
                        </label>



                        <label class="radio-inline">
                            <input type="radio" name="payment_mode_fee" value="upi" disabled><?php echo $this->lang->line('upi'); ?>
                        </label>
