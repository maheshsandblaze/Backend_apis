                ...
                <div class="box border0">
                    ...
                    <ul class="tablists">
                        ...
                        <li class="<?php echo set_Submenu('admin/enquiry'); ?>">
                            <a class="<?php echo set_Submenu('admin/enquiry'); ?>" href="<?php echo base_url(); ?>admin/enquiry"><img src="" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('admission_enquiry'); ?></a>
                        </li>     
                        ...
                        <li class="<?php echo set_Submenu('admin/visitors'); ?>">
                            <a class="<?php echo set_Submenu('admin/visitors'); ?>" href="<?php echo base_url(); ?>admin/visitors"><img src="" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('visitor_book'); ?></a>
                        </li>
                        ...
                        <li class="<?php echo set_Submenu('admin/generalcall'); ?>">
                            <a class="<?php echo set_Submenu('admin/generalcall'); ?>" href="<?php echo base_url(); ?>admin/generalcall"><img src="" alt="icon3" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('phone_call_log'); ?></a>
                        </li> 
                        ...
                        <li class="<?php echo set_Submenu('admin/dispatch'); ?>">
                            <a class="<?php echo set_Submenu('admin/dispatch'); ?>" href="<?php echo base_url(); ?>admin/dispatch"><img src="" alt="icon4" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('postal_dispatch'); ?></a>
                        </li>
                        <?php
                            }
                        ...
                        <li class="<?php echo set_Submenu('admin/receive'); ?>">
                            <a class="<?php echo set_Submenu('admin/receive'); ?>" href="<?php echo base_url(); ?>admin/receive"><img src="" alt="icon5" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('postal_receive'); ?></a>
                        </li>
                        <?php
                            }
                        ...
                        <li class="<?php echo set_Submenu('admin/complaint'); ?>">
                            <a class="<?php echo set_Submenu('admin/complaint'); ?>" href="<?php echo base_url(); ?>admin/complaint"><img src="" alt="icon6" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('complain'); ?></a>
                        </li>
                        <?php
                            }
                        ...
                        <li class="<?php echo set_Submenu('admin/visitorspurpose'); ?>">
                            <a class="<?php echo set_Submenu('admin/visitorspurpose'); ?>" href="<?php echo base_url(); ?>admin/visitorspurpose"><img src="" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('setup_front_office'); ?></a>
                        </li>
                        <?php } ?>
