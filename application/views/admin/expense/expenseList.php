            ...
            <div class="col-md-2">
                <div class="box border0">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('expenses'); ?></h3>
                    </div>
                    <ul class="tablists">
                        <?php if ($this->rbac->hasPrivilege('expense', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('expense/index'); ?>">
                                <a class="<?php echo set_Submenu('expense/index'); ?>" href="<?php echo base_url(); ?>admin/expense"><img src="<?php echo base_url('backend/images/sidebar/submenu/expenses/1.png') ?>" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('add_expense'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('expense/expensesearch'); ?>">
                                <a class="<?php echo set_Submenu('expense/expensesearch'); ?>" href="<?php echo base_url(); ?>admin/expense/expensesearch"><img src="<?php echo base_url('backend/images/sidebar/submenu/expenses/2.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('search_expense'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('expenseshead/index'); ?>">
                                <a class="<?php echo set_Submenu('expenseshead/index'); ?>" href="<?php echo base_url(); ?>admin/expensehead"><img src="<?php echo base_url('backend/images/sidebar/submenu/expenses/3.png') ?>" alt="icon3" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('expense_head'); ?></a>
                            </li>
                        <?php } ?>
