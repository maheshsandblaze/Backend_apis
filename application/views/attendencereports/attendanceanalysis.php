                ...
                <div class="box box-primary pb20">
                    <div>
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-users"></i> Attendance </h3>
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="<?php echo site_url() ?>attendencereports/attendance" class="btn-check-now btn btn-primary">View More Reoprts</a>
                        </div>
