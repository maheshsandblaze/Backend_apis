            ...
            <div class="col-md-2">
                <div class="box border0">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('income'); ?></h3>
                    </div>
                    <ul class="tablists">
                        <?php if ($this->rbac->hasPrivilege('income', 'can_view')) { ?>
                            <li class="<?php echo set_Submenu('income/index'); ?>">
                                <a class="<?php echo set_Submenu('income/index'); ?>" href="<?php echo base_url(); ?>admin/income"><img src="<?php echo base_url('backend/images/sidebar/submenu/income/1.png') ?>" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('add_income'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('income/incomesearch'); ?>">
                                <a class="<?php echo set_Submenu('income/incomesearch'); ?>" href="<?php echo base_url(); ?>admin/income/incomesearch"><img src="<?php echo base_url('backend/images/sidebar/submenu/income/2.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('search_income'); ?></a>
                            </li>
                        ...
                        ?>
                            <li class="<?php echo set_Submenu('incomeshead/index'); ?>">
                                <a class="<?php echo set_Submenu('incomeshead/index'); ?>" href="<?php echo base_url(); ?>admin/incomehead"><img src="<?php echo base_url('backend/images/sidebar/submenu/income/3.png') ?>" alt="icon3" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('income_head'); ?></a>
                            </li>
                        <?php } ?>
