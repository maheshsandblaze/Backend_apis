                                        ...
                                        <?php
                                            foreach ($collect_by as $key => $value) {
                                                ...
                                                <option value="<?php echo $key ?>" <?php                                               
                                                    if ((set_value('assign_by', $assign_by) == $key)) {
                                                        echo "selected";
                                                    }
                        ...
                        <div class="" id="duefee">
                            ...
                            <div class="box-header ptbnull">
                                ...
                                <?php if (!empty($student_remain_fees)) {?>
                                    <button type="submit" class="allot-fees btn btn-primary btn-sm pull-right" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>">Assign Students
                                        <?php }?>
                                    </div>
                            </div>
        ...
        foreach ($student_remain_fees as $student) {
            ...
            ?>
                                                ...
                                                <td> 
                                                                ...
                                                                <input class="checkbox" type="checkbox" name="student_session_id[]"  value="<?php echo $student['student_session_id']; ?>"  <?php if (in_array($student['student_session_id'], $student_ids)) { echo 'checked'; }  ?>/>
