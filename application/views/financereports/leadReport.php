        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('financereports/leadreport') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                                                ...
                                                foreach ($resultarray as $key => $section) {                                                   
                                                      ...
                                                      <tr>
                                                            ...
                                                            <td class="mailbox-date text-right white-space-nowrap">
                                                                <?php if (true) {?>
                                                                    <a class="btn btn-default btn-xs" onclick="follow_up(<?php echo $students->id; ?>, <?php echo $staff_id; ?>);"  data-target="#follow_up" data-toggle="modal"  title="Follow Up Enquiry">
