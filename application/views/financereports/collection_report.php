                        ...
                        <div class="box-body row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group relative">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('fee_types'); ?><small class="req"> *</small></label>
                                    <div id="checkbox-dropdown-container">
                                        <div class="">
                                            ...
                                            <div id="custom-select-option-box" class="custom-select-options">
                                                ...
                                                <div class="custom-select-option checkbox">
                                                    <label class="vertical-middle line-h-18">
                                                        <input value="44" class="custom-select-option-checkbox fee_type_group" type="checkbox" name="feetype_id[]" <?php if (in_array(44, $feegroupIDs)) echo "checked"; ?>>
                                                ...
                                                <?php if (!empty($feetypeList)) {
                                                    foreach ($fee_typeList as $fee_value) { ?>
                                                        <div class="custom-select-option checkbox">
                                                            <label class="vertical-middle line-h-18">
                                                                <input value="<?php echo $fee_value['id']; ?>" class="custom-select-option-checkbox fee_type_group" type="checkbox" name="feetype_id[]" <?php if (in_array($fee_value['id'], $feegroupIDs)) echo "checked"; ?>>
                    ...
                    ?>
                        <div class="">
                            ...
                            <div class="box-body table-responsive" id="transfee">
                                <div id="printhead">
                                    <center><b>
                                            <h4><?php echo $this->lang->line('fees_collection_report') . "<br>";
