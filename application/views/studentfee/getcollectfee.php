        ...
        <div class="form-horizontal">
            <div class="col-lg-12">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input id="date" name="collected_date" placeholder="" type="text" class="form-control date_pay" value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>" readonly="readonly" autocomplete="off">
        ...
        <ul class="fees-list fees-list-in-box">
            ...
            foreach ($feearray as $fee_key => $fee_value) {
                ...
                if ($fee_value->fee_category == "fees") {
                    ...
                    $balanceAmount = $fee_value->totalbalanceAmount;
                        ...
                        <li class="item">
                            ...
                            <div class="product-info">
                                <a href="#" onclick="return false;" class="product-title">
                                    ...
                                    <?php if (isset($fee_value->fee_remaing_amount)) {
                                        $amount_to_be_pay = $fee_value->fee_remaing_amount;
                                    }
                                ...
                                <span class="product-description">
                                    ...
                                    <?php
                                    $selected_fee_types[] = $fee_value->type;
                                    if ($fee_value->is_system) {
                                ...
                                <input name="fee_amount_<?php echo $row_counter; ?>" id="fee_amount_<?php echo $row_counter; ?>" type="text" value="<?php echo $amount_to_be_pay; ?>" class="form-control" oninput="validateAmount(this, <?php echo $amount_to_be_pay; ?>)">
                                <?php
            ...
            <input type="hidden" name="fee_type" value="<?php echo $selected_fee_types_string; ?>">
            <input type="hidden" name="totalbalanceAmount" id="totalbalanceAmount" value="<?php echo $balanceAmount; ?>">
...
<?php if ($total_amount > 0) { ?>
    <div class="row collect_grp_fees">
        ...
        <div class="col-md-4" id="total_pay">
            <span class="pull-right">
