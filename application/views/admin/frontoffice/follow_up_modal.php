        ...
        <div class="taskside">
            ...
            <h5 class="pt0 task-info-created">
                <small class="text-dark"> <b><?php echo $this->lang->line('assigned'); ?></b>:
                    <span class="text-dark"><?php if (!empty($assigned_staff)) {
                                                echo $assigned_staff['name'] . ' ' . $assigned_staff['surname']; ?> <?php if ($assigned_staff['employee_id'] != '') {
            ...
            <div class="task-info task-single-inline-wrap ptt10">
                ...
                <h5><span class="text-dark"><?php echo $this->lang->line('created_by'); ?>:</span>
                    ...
                    <?php if ($staff_role == 7) { ?>
                        ...
                        <?php echo $created_by['name'] . ' ' . $created_by['surname']; ?> <?php if ($created_by['employee_id'] != '') {
