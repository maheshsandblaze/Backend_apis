            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix pt5"><?php echo $this->lang->line('online_course_category'); ?></h3>
                    </div>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="pull-right noExport">
                                                            <a href="<?php echo site_url('user/onlinecourse/list/' . $category['id']); ?>"><i class="fa fa-list"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php 
                                                }
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content" >
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('category') ?></h4>
            </div>
            <form action="<?php echo site_url('admin/onlinecourse/add'); ?>" method="POST" id="formsubject">
                <div class="modal-body">
                    
                    <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="exam">Category Name</label><small class="req"> *</small>
                            <input type="text" class="form-control" id="category_name" name="category_name">
                            <span class="text text-danger category_name_error"></span>
                        </div>
                     </div>
					</div>
				  </div>
...
<div id="bulkUploadOnline" class="modal fade">
    <div class="modal-dialog modal-xl">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
            <input type="hidden" name="recordid" id="online_record_id"value="0">
            <div class="row">
                 <div class="col-md-9">
                    <form method="POST" enctype="multipart/form-data" id="fileUploadFormOnline">

                        <div class="input-group mb10">
                            <input id="my-file-selector-online" data-height="34" class="dropify" type="file">
                            <div class="input-group-btn">
                                <input type="submit" class="btn btn-primary" value="<?php echo $this->lang->line('submit') ?>" id="btnSubmitOnline"/>
                            </div>
                        </div>
                    </div>
                    </form>
                <div class="col-md-3">
                    <button type="submit" class="d-none btn btn-primary btn-sm pull-right bulkonlinesubmit" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> <?php echo $this->lang->line('please_wait'); ?>"><?php echo $this->lang->line('save'); ?>
            </button>
                </div>
            </div>
               <div class="question_list_result quescroll">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-striped" id="bulkData">
                                <thead>
                                </thead>
                                <tbody>
                                </tbody>
