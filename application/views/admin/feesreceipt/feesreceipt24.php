            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('fees_receipt_24'); ?></h3>
                            ...
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('fees_receipt_24'); ?>">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            // echo "<pre>";
                                            // print_r($fee_payments);exit;



                                            // get academic session start year and end year
                                            // $academic_session = $this->customlib->getAcademicSession();
