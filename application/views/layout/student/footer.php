                        ...
                        <div class="navbar-custom-menu">
                            ...
                            <ul class="nav navbar-nav headertopmenu">
                                ...
                                <li class="dropdown user-menu">
                                    <a class="dropdown-toggle profile-text" style="padding: 15px 13px;" href="<?php echo base_url(); ?>user/user/profile" aria-expanded="false">
                                        <?php if ($sch_setting->student_photo) {
                                        ?>
                                            <img src="<?php echo $file . img_time(); ?>" class="topuser-image" alt="User Image"> <?php echo $this->lang->line('my_profile'); ?>
                                        <?php
                                        } ?>
