            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs pull-right">
                        <li class="pull-right header"> <button onclick="window.history.back(); " class="btn btn-primary btn-xs"> <i class="fa fa-arrow-left"></i> Back</button></li>
                        <li class="pull-left header w-xs-100">Send Whatsapp Messgae</li>
<!--                        <li><a href="#tab_birthday" data-toggle="tab"><?php echo $this->lang->line('todays_birtday'); ?></a></li>-->
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_group">
                            <form action="<?php echo site_url('admin/sendwhatsapp/send_group_sms') ?>" method="post" id="group_form">
                                <!-- /.box-header -->
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-8">
...
-->
                                            ...
                                            <div class="form-group">
                                                 <label>Message Type</label><small class="req"> *</small>
                                                 <select name="message_type_group" id="message_type_group" class="form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                            ...
                                            <div class="form-group" id="video_link_group" style="display:none">
                                                ...
                                                <input type="url" name="video_link_grp" id="video_link_grp" class="form-control" autocomplete="off">
                                            </div>
...
?>
                        ...
                        <div class="tab-pane" id="tab_perticular">
                            <form action="<?php echo site_url('admin/sendwhatsapp/send_individual_sms') ?>" method="post" id="individual_form">
                                <!-- /.box-header -->
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-8">
...
-->
                                            ...
                                            <div class="form-group">
                                                 <label>Message Type</label><small class="req"> *</small>
                                                 <select name="message_type_individual" id="message_type_individual" class="form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <option value="text">Text</option>
                                                    <option value="video">Video</option>
                                                 </select>
                                            ...
                                            <div class="form-group" id="video_link_individual" style="display:none">
                                                <label>Video Link</label>
                                                <input type="url" name="video_link_indv" id="video_link_indv" class="form-control" autocomplete="off">
                                            </div>
...
?>
                        ...
                        <div class="tab-pane" id="tab_class">
                            <form action="<?php echo site_url('admin/sendwhatsapp/send_class_sms') ?>" method="post" id="class_form">
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-8">
<!--
...
-->
                                            ...
                                            <div class="form-group">
                                                 <label>Message Type</label><small class="req"> *</small>
                                                 <select name="message_type_class" id="message_type_class" class="form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <option value="text">Text</option>
                                                    <option value="video">Video</option>
                                                 </select>
                                            ...
                                            <div class="form-group" id="video_link_class" style="display:none">
                                                <label>Video Link</label>
                                                <input type="url" name="video_link_cls" id="video_link_cls" class="form-control" autocomplete="off">
                                            </div>
...
?>
                        ...
                        <div class="tab-pane" id="tab_birthday">
                            <form action="<?php echo site_url('admin/sendwhatsapp/send_birthday_sms') ?>" method="post" id="birthday_form">
                                <!-- /.box-header -->
                                <div class="">
                                    <div class="row">
                                        <div class="col-md-8">
...
<script>
document.getElementById('message_type_group').addEventListener('change', function() {
    var videoLinkGroup = document.getElementById('video_link_group');
    if (this.value === 'video') {
...
document.getElementById('message_type_individual').addEventListener('change', function() {
    var videoLinkIndividual = document.getElementById('video_link_individual');
    if (this.value === 'video') {
        videoLinkIndividual.style.display = 'block';
    } else {
        videoLinkIndividual.style.display = 'none';
    }
});


document.getElementById('message_type_class').addEventListener('change', function() {
    var videoLinkClass = document.getElementById('video_link_class');
    if (this.value === 'video') {
        videoLinkClass.style.display = 'block';
    } else {
        videoLinkClass.style.display = 'none';
    }
});
</script>