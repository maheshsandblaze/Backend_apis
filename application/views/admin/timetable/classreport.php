            ...
            <div class="col-md-2">
                <div class="box border0">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('academics'); ?></h3>
                    </div>
                    <ul class="tablists">
                        <?php if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('Academics/timetable'); ?>">
                            <a class="<?php echo set_Submenu('Academics/timetable'); ?>" href="<?php echo base_url(); ?>admin/timetable/classreport"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/1.png') ?>" alt="icon1" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('class_timetable'); ?></a>
                        </li>     
                        ...
                        <li class="<?php echo set_Submenu('Academics/timetable/mytimetable'); ?>">
                            <a class="<?php echo set_Submenu('Academics/timetable/mytimetable'); ?>" href="<?php echo base_url(); ?>admin/timetable/mytimetable"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/2.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('teachers') . " " . $this->lang->line('timetable'); ?></a>
                        </li>
                        ...
                        <?php
                            ...
                            if ($this->rbac->hasPrivilege('assign_class_teacher', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('admin/teacher/assign_class_teacher'); ?>">
                            <a class="<?php echo set_Submenu('admin/teacher/assign_class_teacher'); ?>" href="<?php echo base_url(); ?>admin/teacher/assign_class_teacher"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/3.png') ?>" alt="icon3" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('assign_class_teacher'); ?></a>
                        </li> 
                        ...
                        <li class="<?php echo set_Submenu('stdtransfer/index'); ?>">
                            <a class="<?php echo set_Submenu('stdtransfer/index'); ?>" href="<?php echo base_url(); ?>admin/stdtransfer"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/4.png') ?>" alt="icon4" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('promote_students'); ?></a>
                        </li>
                        <?php
                            }
                            if ($this->rbac->hasPrivilege('subject_group', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('subjectgroup/index'); ?>">
                            <a class="<?php echo set_Submenu('subjectgroup/index'); ?>" href="<?php echo base_url('admin/subjectgroup'); ?>"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/5.png') ?>" alt="icon5" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('subject') . " " . $this->lang->line('group'); ?></a>
                        </li>
                        <?php
                            }
                            if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('Academics/subject'); ?>">
                            <a class="<?php echo set_Submenu('Academics/subject'); ?>" href="<?php echo base_url(); ?>admin/subject"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/6.png') ?>" alt="icon6" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('subjects'); ?></a>
                        </li>
                        <?php
                            }
                        ...
                        <li class="<?php echo set_Submenu('classes/index'); ?>">
                            <a class="<?php echo set_Submenu('classes/index'); ?>" href="<?php echo base_url(); ?>classes"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/7.png') ?>" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('class'); ?></a>
                        </li>
                        <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('section', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('sections/index'); ?>">
                                    <a class="<?php echo set_Submenu('sections/index'); ?>" href="<?php echo base_url(); ?>sections"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/8.png') ?>" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('sections'); ?></a>
                                </li>
                            <?php
                            }
                            ...
                            if ($this->rbac->hasPrivilege('assign_subject_teacher', 'can_view')) {
                                ?>   
                             <li class="<?php echo set_Submenu('teacher/assign_subject_teacher'); ?>">
                                    <a class="<?php echo set_Submenu('teacher/assign_subject_teacher'); ?>" href="<?php echo base_url(); ?>admin/teacher/assign_subject_teacher"><img src="<?php echo base_url('backend/images/sidebar/submenu/academic/9.png') ?>" alt="icon7" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('assign_subject_teacher'); ?></a>
                                </li>
                            <?php
                                }
                            ?>    
