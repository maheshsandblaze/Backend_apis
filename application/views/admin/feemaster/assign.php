                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/feemaster/assign/' . $id) ?>" method="post" class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('pickuppoint'); ?></label>
                                    <select id="pickuppoint_id" name="pickuppoint_id" class="form-control">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php
                                        foreach ($listpickup_pointlist as $pickpoint) {
                                        ?>
                                            <option value="<?php echo $pickpoint['id'] ?>" <?php if (set_value('pickuppoint_id') == $pickpoint['id']) echo "selected=selected"; ?>><?php echo $pickpoint['name'] ?></option>
                                        <?php
                                            $count++;
                                        }
                                        ?>
                                                    ...
                                                    ?>
                                                        <h4 class="mt2">
                                                            ...
                                                            <a href="#" data-toggle="popover" class="detail_popover">
                                                                ...
                                                                <?php if ($feegroup->is_system) {
                                                                    echo $this->lang->line($feegroup->group_name);
                                                                } else {
