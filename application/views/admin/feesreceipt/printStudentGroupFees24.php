                    ...
                    <div class="col-xs-12 text-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                if ($student->class != 'Grade-6' && $student->class != 'Grade-7' && $student->class != 'Grade-8' && $student->class != 'Grade-9' && $student->class != 'Grade-10') {
                        ...
                        <table class="table table-striped table-bordered" style="font-size: 8pt; width:95%">
                            ...
                            <tbody>
                                ...
                                <tr class="dark-gray">
                                    ...
                                    <td><?php if ($student->mode == "Cash") {

                                            echo  $student->mode;
                                        } else {
                                            echo $this->lang->line($student->mode);
                                        } ?></td>
                                ...
                                <tr>
                                    <td colspan="9">
                                        ...
                                        // }
                                        echo $this->lang->line('remarks'); ?>: <?php echo $student->fee_types;
                                                                                ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <!-- <tr>
                                    <td colspan="9">
                                        Balance Amount: <?php
                                                        // $amount = $record->amount;
                                                        echo $currency_symbol . (amountFormat($student->balanceAmount));
                                                        ?>
                                    </td>
                                </tr> -->
                                <tr>
