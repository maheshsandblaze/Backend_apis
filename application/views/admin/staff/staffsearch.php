                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <select name="role" class="form-control">
                                                    ...
                                                    <?php foreach ($staff_role as $key => $role_value) {
                                                    ...
                                                    ?>
                                                        <option <?php
                                                                if ($staff_role_id == $role_value["id"]) {
                                                                    echo "selected";
                                                                }
                                    ...
                                    <div class="mediarow">
                                        <div class="row">
                                            <?php if (empty($resultlist)) { ?>
                                                ...
                                                foreach ($resultlist as $staff) {
                                                ?>
                                                    <?php if ($staff["user_type"] != "Super Admin") { ?>
                                                        ...
                                                        <div class="col-lg-3 col-md-4 col-sm-6 img_div_modal">
                                                            <div class="staffinfo-box">
                                                                ...
                                                                <div class="staffleft-content">
                                                                    ...
                                                                    <p>
                                                                        <font data-toggle="tooltip" title="<?php echo "Employee Id"; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $staff["employee_id"] ?></font>
                                                                    </p>
                                                                    <p>
                                                                        <font data-toggle="tooltip" title="<?php echo "Contact Number"; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $staff["contact_no"] ?></font>
                                                                    </p>
                                                                    <p>
                                                                        <font data-toggle="tooltip" title="<?php echo 'Location'; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php
                                                                                                                                                                                                                                                        if (!empty($staff["location"])) {
                                                                                                                                                                                                                                                            echo $staff["location"] . ",";
                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                        ?></font>
                                                                        <font data-toggle="tooltip" title="<?php echo 'Department'; ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"> <?php echo $staff["department"]; ?></font>
                                                                    </p>
