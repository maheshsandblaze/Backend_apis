    ...
    ?>
                                ...
                                <div class="box box-primary borderwhite">
                                    <div class="box-header ptbnull bgtgray">
                                        <h3 class="box-title titlefix"><?php echo $this->lang->line('apply_date'); ?>: <span><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($value['apply_date'])); ?></span></h3>
                                        <div class="box-tools pull-right">
                                            <?php
if ($value['status'] == 0) {
        ?>
                                    ...
                                    <div class="box-body">
                                            ...
                                            <div class="">
                                                <div class="description-block">
                                                    <h5 class="description-header"><?php echo $this->lang->line('from_date'); ?> : <span class="description-text"><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($value['from_date'])); ?></span></h5>
                                                </div>
    ...
    ?>
                                                <small <?php echo $label ?>><?php echo $status.' '.$approve_date.''; ?></small>
                                                </div>
                                        </div>
                                        
                                        
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('to_date'); ?> : <span class="description-text"><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($value['to_date'])); ?></span></h5>
                                            </div>
                                        
                                        
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('reason'); ?> : <span class="description-text"><?php echo $value['reason']; ?></span></h5>
                                            </div>
