...
<head>
    ...
    <script type="text/javascript">
        ...
        var chk_validate = "<?php echo $this->config->item('wisibles') ?>";
    </script>
    ...
    <style type="text/css">
        ...
        #loading {
            ...
            width: 100%;
            height: 100vh;
            background: #fff url('<?php echo base_url() ?>backend/images/load2.gif') no-repeat center center;
            z-index: 99999;
        }
    </style>
</head>

<body class="hold-transition skin-blue fixed sidebar-mini" onload="myFunction()">
    <div id="loading">
    ...
    <div class="wrapper">
        ...
        <header class="main-header hide-mobile" id="alert">
            <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo-hide-on-mobile logo">
