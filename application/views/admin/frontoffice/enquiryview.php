                    ...
                    <ul class="tablists">
                        ...
                        <?php
                            ...
                            if ($this->rbac->hasPrivilege('visitor_book', 'can_view')) {
                                ?>
                        <li class="<?php echo set_Submenu('admin/visitors'); ?>">
                            <a class="<?php echo set_Submenu('admin/visitors'); ?>" href="<?php echo base_url(); ?>admin/visitor_management"><img src="<?php echo base_url('backend/images/sidebar/submenu/front_office/2.png') ?>" alt="icon2" class="img-fluid" style="width:20px"> <?php echo $this->lang->line('visitor_management'); ?></a>
                        </li>    
