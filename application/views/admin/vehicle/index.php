            ...
            <div class="col-md-12">
                <div class="box box-info"><div class="box-header ptbnull">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-backdrop="static" data-target="#myModal"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add'); ?></button>
                            <?php } ?>
