                            ...
                            <div class="bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Class Of Admission</label>
                                                <input id="class_of_admission" name="class_of_admission" placeholder="" type="text" class="form-control" value="<?php echo set_value('class_of_admission'); ?>" />
                                                <span class="text-danger"><?php echo form_error('class_of_admission'); ?></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Child ID</label><small class="req"> *</small>
                                                <input id="child_id" name="child_id" placeholder="" type="text" class="form-control" value="<?php echo set_value('child_id'); ?>" />
                                                <span class="text-danger"><?php echo form_error('child_id'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row around10">
                                <div class="col-md-12">
                                    <?php if (!empty($feesessiongroup_model)) { ?>
                                        <div class="form-group">
                                            <label><?php echo $this->lang->line('select_fee_groups'); ?></label>
                                            <select class="form-control select2" multiple="multiple" name="fee_session_group_id[]" id="fee_group_select">
                                                <?php
                                                foreach ($feesessiongroup_model as $feesessiongroup_key => $feesessiongroup_value) {
                                                    $total_fees = 0;
                                                    foreach ($feesessiongroup_value->feetypes as $fee_type_key => $fee_type_value) {
                                                    ...
                                                    $selected = (isset($_POST['fee_session_group_id']) && in_array($feesessiongroup_value->id, $_POST['fee_session_group_id'])) ? 'selected' : '';
                                                ?>
                                                    <option value="<?php echo $feesessiongroup_value->id; ?>" data-amount="<?php echo $total_fees; ?>" <?php echo $selected; ?>>
                                                        <?php echo $feesessiongroup_value->group_name . ' - ' . amountFormat($total_fees); ?>
                                                    </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="table-responsive border0">
                                            <table class="table mb0">
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr class="fee-group-details fee-group-<?php echo $feesessiongroup_value->id; ?>" style="display: none;">
                                                            <td colspan="3" class="mailbox-name white-space-nowrap border0">
                                                                <div class="panel-group1 mb0">
                                                                    <div class="panel panel-default1">
                                                                        <div class="panel-heading pt5 pb5">
                                                                            <h6 class="panel-title panel-title1 overflow-hidden">
                                                                                ...
                                                                                <span class="float-right bmedium pt3 fee_group_total"><?php echo amountFormat($total_fees); ?></span>
                                                                            </h6>
                                                                        </div>
                                                                        <div id="collapse_fees_<?php echo $feesessiongroup_value->id ?>">
                                                                            <ul class="list-group ui-sortable">
                                                                                <li class="list-group-item">
                                                                                    <div class="row">
                                                                                        <div class="col-md-6 col-sm-6 bmedium">
                                                                                            <?php echo $this->lang->line('fees_type'); ?>
                                                                                        </div>
                                                                                        <div class="col-md-3 col-sm-3 bmedium text-center">
                                                                                            <?php echo $this->lang->line('due_date'); ?>
                                                                                        </div>
                                                                                        <div class="col-md-3 col-sm-3 bmedium text-right">
                                                                                            <?php echo $this->lang->line('amount'); ?> (<?php echo $currency_symbol; ?>)
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                                <?php
...
<script>
    $(document).ready(function() {
        ...
        // Calculate and update total fees when selection changes
        $('#fee_group_select').change(function() {
            var total = 0;
            $('option:selected', this).each(function() {
                total += parseFloat($(this).data('amount'));
            });
            $('.total_fees_alloted').text(total.toFixed(2));
            $('input[name="total_post_fees"]').val(total);

            // Show/hide fee group details
            $('.fee-group-details').hide();
            $(this).find('option:selected').each(function() {
                $('.fee-group-' + $(this).val()).show();
            });
        });

        // Trigger change event on page load to show initially selected items
        $('#fee_group_select').trigger('change');
    });
</script>