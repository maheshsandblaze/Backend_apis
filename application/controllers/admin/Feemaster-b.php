...
class Feemaster extends Admin_Controller
{
    ...
    public function assign($id)
    {
        ...
        // echo "<pre>";
        // print_r($data['listpickup_point']);exit;
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            $data['pickuppoint_id'] = $this->input->post('pickuppoint_id');

            $resultlist         = $this->studentfeemaster_model->searchAssignFeeByClassSection($data['class_id'], $data['section_id'], $id, $data['category_id'], $data['gender'], $data['rte_status'],$data['pickuppoint_id']);
