...
foreach ($categorylist as $value) {
    ...
    ?>
                        ...
                        <div class="row no-print mb10 hide-mobile">
...
if ($fee_value->is_system) {
            ...
            ?></h3>
                                        <div class="box-tools pull-right">
                                            <button  class="btn btn-sm btn-primary printDoc" data-main_invoice="<?php echo $fee_value->student_fees_deposite_id ?>" data-sub_invoice="<?php echo $fee_deposits_value->inv_no ?>"  data-fee-category="fees"  title="<?php echo $this->lang->line('print'); ?>"><?php echo $this->lang->line('print'); ?></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="box-body">
                                        <div class="">
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('fees_code'); ?> : <span class="description-text"><?php
if ($fee_value->is_system) {
                echo $this->lang->line($fee_value->code);
            } else {
                echo $fee_value->code;
...
if ($feetype_balance == 0) {
            ...
            ?>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('due_date'); ?> : <span class="description-text"><?php
            if ($fee_value->due_date) {
                echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($fee_value->due_date));
            } else {
            ...
            ?></span></h5>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('amount') ?> : <span class="description-text">
...
if ($fee_value->fine_amount != "") {
    ...
    <?php
            ...
            ?>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('fine'); ?> :<span class="description-text"><?php
echo amountFormat($fee_fine);
            ?></span></h5>
                                            </div>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('discount'); ?> : <span class="description-text"><?php
echo amountFormat($fee_discount);
            ?>
                                                </span></h5>
                                            </div>
                                            ...
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('paid'); ?> Amt :<span class="description-text"><?php
echo amountFormat($fee_paid);
            ?></span></h5>
                                            </div>
                                            
                                            <div class="description-block">
                                                <h5 class="description-header"><?php echo $this->lang->line('balance'); ?> :<span class="description-text"><?php
$display_none = "ss-none";
            if ($feetype_balance > 0) {
                $display_none = "";
                echo amountFormat($feetype_balance);
...
if (!empty($fee_value->amount_detail)) {
                ...
                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                    ...
                    <div class="box-header ptbnull">
                                        <h3 class="box-title titlefix"><?php echo $this->lang->line(payment_details); ?></h3>
                    </div>
                    
                    <div class="description-block">
                        <h5 class="description-header"><?php echo $this->lang->line('payment_id'); ?> :<span class="description-text"><?php echo $fee_value->student_fees_deposite_id . "/" . $fee_deposits_value->inv_no; ?></span></h5>
                    </div>
                    
                    <div class="description-block">
                        <h5 class="description-header"><?php echo $this->lang->line('mode'); ?> :<span class="description-text"><?php echo $this->lang->line(strtolower($fee_deposits_value->payment_mode)); ?></span></h5>
                    </div>
                    
                    <div class="description-block">
                        <h5 class="description-header"><?php echo $this->lang->line('payment_date'); ?> :<span class="description-text"><?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($fee_deposits_value->date)); ?></span></h5>
                    </div>
                    
                    <div class="description-block">
                        <h5 class="description-header"><?php echo $this->lang->line('discount'); ?> :<span class="description-text"><?php echo amountFormat($fee_deposits_value->amount_discount); ?></span></h5>
                    </div>
                    
                    <div class="description-block">
                        <h5 class="description-header"><?php echo $this->lang->line('fine'); ?> :<span class="description-text"><?php echo amountFormat($fee_deposits_value->amount_fine); ?></span></h5>
                    </div>
                    
                    <div class="description-block">
                        <h5 class="description-header"><?php echo $this->lang->line('amount'); ?> :<span class="description-text"><?php echo amountFormat($fee_deposits_value->amount); ?></span></h5>
                    </div>
