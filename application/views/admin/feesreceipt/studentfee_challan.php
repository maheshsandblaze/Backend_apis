            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"> <?php echo $this->lang->line('student_challan'); ?></h3>
                    ...
                    <div class="box-body">
                        <div class="table-responsive overflow-visible">
                            <table class="table table-striped table-bordered table-hover example" data-export-title="<?php echo $this->lang->line('student_challan'); ?>">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th><?php echo $this->lang->line('challan_no'); ?></th>
                                        <th><?php echo $this->lang->line('challan_date'); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    echo date('d/m/Y', strtotime($fee_value->due_date));
                                                    ?>
                                            </td>
                                            ...
                                            <td class="text-right noExport">
                                                <button  class="btn btn-xs btn-default printDocNew" data-receipt_id="<?php echo $fee_value->id; ?>" data-student_id="<?php echo $fee_value->student_session_id; ?>" title="<?php echo $this->lang->line('print'); ?>"><i class="fa fa-print"></i> </button>
                                            </td>
                                        </tr>
                                        <?php
                                            $count++;
...
$(document).on('click', '.printDocNew', function () {
            ...
            var student_id = $(this).data('student_id');
                ...
                $.ajax({
                    url: '<?php echo site_url("admin/feesreceipt/printStudentchallan") ?>',
                    type: 'post',
                    dataType:"JSON",
                    data: {'student_id': student_id, 'receipt_id': receipt_id},
